...
CREATE TABLE `alquiler` (
  ...
  CONSTRAINT `FKAlquiler321815` FOREIGN KEY (`idAlquiler`) REFERENCES `reservas` (`idAlquiler`),
...
CREATE TABLE `reservas` (
  ...
  CONSTRAINT `FKReservas702790` FOREIGN KEY (`idUsuario`) REFERENCES `usuarios` (`idUsuario`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2015-12-25 23:06:34