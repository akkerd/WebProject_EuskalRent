            ...
            <div  id="contenedorJumbotron" class="container-fluid" > 
                ...
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        <div class="col-md-4">
                            <img src="img/alojamientos/<%=fotoAlq%>" class="col-md-4 img-thumbnail img-aloj" alt="foto" >
                            
                            <hr>
                            <%
                             //Es necesario tener los datos del usuario arrendaddor para las siguientes lineas
                            Usuario arrendador = conexion.buscarUsuarioporAlquiler(idAlquiler);
                            
                            String nombre = arrendador.getNombreCompleto();
                            int tel = arrendador.getTelefono();
                            String email = arrendador.getEmail();
                            String fotoArr = arrendador.getFotoPerfil();
                            ...
                            %>
                            <div class="datos-arrendador">
                                <label>Arrendador:</label>
                                <div name="arrendador"  id="arrendador" class="form-control"><%=nombre%></div>
                                ...
                                <br>
                                <img src="<%="/img/perfil/"+fotoArr%>" class="col-md-4 img-thumbnail img-arrendador" alt="foto" >
                            </div>
                        </div>
                ...
                <div class="col-md-12">
                            ...
                            <%
                                if(usuario != null)
                                {
                                    ...
                                    %>
                                    <h4 style="text-align: center" >Tu reserva para el alojamiento <%=alquiler.getTitulo()%> desde el día <%=dateEntrada%> hasta el <%=dateSalida%> tiene un coste de <%=alquiler.getPrecioTotal(dateEntrada, dateSalida)%></h4>
                                    <br> 
                               <form class="form" role="form" action="registroReserva" method="post" accept-charset="UTF-8">
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            <label for="nHuesp">Número máximo de husepedes:</label>
                                            <input type="number" name="nHuesp" min="1" max="<%=alquiler.getAlojamiento().getNumHuespedes() %>"   id="nHuesp" class="form-control" required>
