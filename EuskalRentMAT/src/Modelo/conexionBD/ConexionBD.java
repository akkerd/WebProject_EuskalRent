...
public class ConexionBD {
    ...
    **********************************************/
     ...
     /**
    * Metodo para recuperar un usuario dado un alquiler.
    * 
    * @return Usuario validado
    * 
    */
    public Usuario buscarUsuarioporAlquiler(int idAlquiler){       
        try{           
            /* Creamos la conexion con la base de datos */
            Connection conexion = getConexion();
            /* Guardamos la sentencia SQL */
            String sql = "SELECT R.* FROM USUARIOS R INNER JOIN ALQUILER L ON ( R.idUsuario = L.IdUsuario) where L.idAlquiler = " + idAlquiler + "";
    ...
    */
    public void actualizarAlojamiento(Alojamiento alojamiento){
       ...
       /**
    * Metodo para actualizar el saldo del propietario de un alquiler
    * 
    * @param idAlquiler
    */
    public void actualizarSaldoporAlquiler(int idAlquiler, float saldo){
        try{
            /* Creamos la conexion con la base de datos */
            Connection conexion = getConexion();
            /* Guardamos la sentencia SQL */

            String sql =  "Update usuarios set saldo = saldo + "+ saldo +" where idUsuario = ( select idUsuario from (select S.* from usuarios S inner join alquiler R on ( S.idUsuario = R.idUsuario) where R.idAlquiler = "+ idAlquiler +") as aux);";
