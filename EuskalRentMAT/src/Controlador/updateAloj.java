...
public class updateAloj extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String foto = request.getParameter("fotoAlojamiento");
            ...
            Alojamiento alojamiento = new Alojamiento(idAlojamiento,tipoAlojamiento,numMax,barrio,direccion,foto,tarifa,politica,comentario);
